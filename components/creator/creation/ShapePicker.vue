<template>
  <fieldset class="border rounded border-zinc-600 flex gap-4 px-3 py-4 items-start">
    ...
    <div class="flex flex-col pointer-fine:hidden gap-2 border border-zinc-600 rounded">
